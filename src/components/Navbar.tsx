            ...
            <div className='flex-2 flex max-md:gap-6 items-center justify-end md:bg-[#fcf5f3] h-full rounded'>
                {
                    userData
                        ...
                        <div className='flex items-center gap-2 font-bold md:mr-2'>
                            ...
                            />
                            <span className='max-md:hidden'>John Doe</span>

                            <Link href="/profile" className='relative px-3 py-1 md:px-6 md:py-2 bg-[#fece51] border-none max-md:text-xs cursor-pointer rounded group'>
                                <div className='absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-4.5 h-4.5 md:w-6.5 md:h-6.5 flex items-center max-md:text-xs justify-center'>0</div>
                                <span>Profile</span>
                            </Link>
                            <div className='hidden ml-4 bg-red-400 px-3 py-1 md:flex items-center gap-1 rounded cursor-pointer'>
                        ...
                        :
                        <div className=''>
                            <button className='font-[600] px-3 py-1.5 md:px-6 md:py-3 max-md:text-xs bg-[#fece51] text-black mr-2 rounded hover:scale-105 ease-in duration-400 cursor-pointer'>Sign In</button>
                        </div>
                }
